    ...
    <br><br>
        ...
        <div  id="doc" style="border-style: groove;border-width:2px;">
            <div class="row" style="font-size:20px;">
                <div class="col-md-4">
                    <ul >
                        <img src="<?php $anh = 'crud/img/'.$fac['Anh']; echo $anh ?>" alt="..." style = "width:400px;">
                    </ul>
                </div>
                <div class="col-md-8" >
                    <ul >
                        <br>
                            <p style="font-size:20px;"><span class="fa fa-plus-square" style="font-size:20px;"> Khoa:  </span><?php echo $fac['Ten_khoa']; ?></p>
                            <hr>
                            <p style="font-size:20px;"><span class="fa fa-medkit" style="font-size:20px;"> Mô tả:  </span><?php echo $fac['Mo_ta']; ?></p>
                            <hr>
                            <p style="font-size:20px;"><span class="fa fa-trophy" style="font-size:20px;"> Thành tựu:  </span><?php echo $fac['Thanh_tuu']; ?></p>
                            <hr>
                            <p style="font-size:20px;"><span class="fa fa-phone" style="font-size:20px;"> Số điện thoại:  </span><?php echo $fac['So_dien_thoai']; ?></p>
                            <hr>
                    </ul>
                </div>
