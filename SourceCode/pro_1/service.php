    ...
    <br><br>
        ...
        <div  id="doc" style="border-style: groove;border-width:2px;">
            <div class="row" style="font-size:20px;">
                <div class="col-md-4">
                    <ul >
                        <img src="<?php $anh = 'crud/img/'.$ser['Anh']; echo $anh ?>" alt="..." style = "width:400px;">
                    </ul>
                </div>
                <div class="col-md-8" >
                    <ul >
                        <br>
                            <p style="font-size:20px;"><span class="fa fa-ambulance" style="font-size:20px;"> Dịch vụ:  </span><?php echo $ser['Ten_dich_vu']; ?></p>
                            <hr>
                            <p style="font-size:20px;"><span class="fa fa-money" style="font-size:20px;">:  </span><?php echo adddotstring($ser['Gia']) . 'vnđ'; ?></p>
                            <hr>
                            <p style="font-size:20px;"><span class="fa fa-clock-o" style="font-size:20px;"> Thời gian thực hiện:  </span><?php echo $ser['Thoi_gian_thuc_hien'] . 'h'; ?> </p>
                            <hr>
                    </ul>
                </div>
